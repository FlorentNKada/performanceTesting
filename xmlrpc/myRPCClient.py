...
NUMBER_OF_THREADS = 1 #the number of clients to connect to the server
...
class Client(threading.Thread):
    ...
    def run(self):
        """The thread connects to the server, then it calls any of the
...
if __name__ == "__main__":
    ...
    - Each thread runs the 'run()' method.
    ...
    ########################################################################
    # This part depends on the test you run and on the file you want to    #
